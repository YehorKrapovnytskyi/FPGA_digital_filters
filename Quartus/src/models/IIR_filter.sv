...
// Generated on: 2021-12-09 19:07:23
// -------------------------------------------------------------
...
module IIR_filter
  ...
  input   i_clk_enable; 
  input   i_reset; 
  input   signed [11:0] i_iir_data; //sfix12_En11
  output  signed [27:0] o_iir_data; //sfix28_En22
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [15:0] scaleconst1 = 16'b0111111000001111; //sfix16_En20
  ...
  parameter signed [15:0] coeff_a2_section1 = 16'b1001011110101111; //sfix16_En14
  parameter signed [15:0] coeff_a3_section1 = 16'b0011000000110010; //sfix16_En14
  parameter signed [15:0] scaleconst2 = 16'b0110101101010010; //sfix16_En20
  ...
  parameter signed [15:0] coeff_a2_section2 = 16'b1010011100110001; //sfix16_En14
  parameter signed [15:0] coeff_a3_section2 = 16'b0001111110000100; //sfix16_En14
  // Signals
  reg  signed [11:0] input_register; // sfix12_En11
  wire signed [47:0] scale1; // sfix48_En46
  wire signed [27:0] mul_temp; // sfix28_En31
  ...
  wire signed [47:0] scale2; // sfix48_En46
  ...
  wire signed [27:0] output_typeconvert; // sfix28_En22
  reg  signed [27:0] output_register; // sfix28_En22
    ...
    begin: input_reg_process
      if (i_reset == 1'b0) begin
        ...
        if (i_clk_enable == 1'b1) begin
          input_register <= i_iir_data;
        end
      end
    end // input_reg_process

  assign mul_temp = input_register * scaleconst1;
  assign scale1 = $signed({mul_temp, 15'b000000000000000});

  assign scaletypeconvert1 = scale1[47:16];
  ...
  assign scaletypeconvert2 = scale2[47:16];
  ...
  assign output_typeconvert = b1sum2[39:12];
  ...
  assign o_iir_data = output_register;
